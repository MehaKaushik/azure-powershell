...
function Test-MongoOperationsCmdlets
{
  ...
  Assert-AreEqual $NewDatabase.MongoDatabaseGetResultsId $Database.MongoDatabaseGetResultsId
  ...
  Assert-AreEqual $NewCollection.MongoCollectionGetResultsId $Collection.MongoCollectionGetResultsId
  Assert-AreEqual $NewCollection._rid $Collection._rid
  Assert-AreEqual $NewCollection._ts $Collection._ts
  Assert-AreEqual $NewCollection._etag $Collection._etag
