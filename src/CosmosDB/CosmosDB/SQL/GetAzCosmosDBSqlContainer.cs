...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBSqlContainer"), OutputType(typeof(PSSqlContainerGetResults), typeof(PSThroughputSettingsGetResults))]
