...
{
    [Cmdlet(VerbsCommon.Get, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBSqlDatabase"), OutputType(typeof(PSSqlDatabaseGetResults), typeof(PSThroughputSettingsGetResults))]
