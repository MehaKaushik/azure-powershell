...
namespace Microsoft.Azure.Commands.CosmosDB
{
    ...
    public class SetAzCosmosDBCassandraTable : AzureCosmosDBCmdletBase
    {
        ...
        [Parameter(Mandatory = true, HelpMessage = Constants.CassandraSchemaHelpMessage)]
        public PSCassandraSchema Schema { get; set; }

        [Parameter(Mandatory = true, ParameterSetName = ParentObjectParameterSet, HelpMessage = Constants.CassandraKeyspaceObjectHelpMessage)]
