...
namespace Microsoft.Azure.Commands.CosmosDB.Models
{
    ...
    public class PSMongoDBDatabaseGetResults 
    {
        ...
        public PSMongoDBDatabaseGetResults(MongoDBDatabaseGetResults mongoDBDatabaseGetResults)
        {
            ...
            MongoDBDatabaseGetResultsId = mongoDBDatabaseGetResults.MongoDBDatabaseGetResultsId;
            _rid = mongoDBDatabaseGetResults._rid;
            _ts = mongoDBDatabaseGetResults._ts;
            _etag = mongoDBDatabaseGetResults._etag;
        }
