...
{
    public partial class CosmosDBResourceManagementClient : FluentServiceClientBase<CosmosClient>, ICosmosDB, IAzureClient
    {
        private Management.CosmosDB.Fluent.CosmosDB cosmosDB;

        /// <summary>
        /// Initializes a new instance of the CosmosDBResourceManagementClient class.
        /// </summary>
        /// <exception cref="System.ArgumentNullException">
        /// Thrown when a required parameter is null
        /// </exception>
        public CosmosDBResourceManagementClient(
            Uri baseUri,
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public CosmosDBResourceManagementClient(RestClient restClient) : base(restClient)
        {
        }
        /// <summary>
